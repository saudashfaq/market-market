        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 lg:p-12">
            ...
            <?php if ($tokenValid): ?>
                ...
                <div class="text-center">
                    ...
                    <div class="space-y-3">
                        <a href="<?= rtrim(str_replace('/public', '', BASE), '/') . '/public/index.php?p=login&tab=login' ?>" class="block w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-[1.02] transition-all duration-200 shadow-lg">
                            <i class="fas fa-sign-in-alt mr-2"></i>
                            Login to Your Account
                        </a>
                        <a href="<?= rtrim(str_replace('/public', '', BASE), '/') . '/public' ?>" class="block w-full bg-gray-100 text-gray-700 font-semibold py-3 px-6 rounded-xl hover:bg-gray-200 transition-all duration-200">
            ...
            <?php elseif ($alreadyVerified): ?>
                ...
                <div class="text-center">
                    ...
                    <a href="<?= rtrim(str_replace('/public', '', BASE), '/') . '/publc/index.php?p=login&tab=login' ?>" class="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-[1.02] transition-all duration-200 shadow-lg">
                        <i class="fas fa-sign-in-alt mr-2"></i>
                        Go to Login
                    </a>
                </div>
            ...
            <?php elseif ($tokenExpired): ?>
                ...
                <div class="text-center">
                    ...
                    <a href="resend-verification.php" class="inline-block bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold py-3 px-6 rounded-xl hover:from-orange-600 hover:to-red-600 transform hover:scale-[1.02] transition-all duration-200 shadow-lg">
            ...
            <?php else: ?>
                ...
                <div class="text-center">
                    ...
                    <div class="space-y-3">
                        <a href="resend-verification.php" class="block w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-[1.02] transition-all duration-200 shadow-lg">
                            <i class="fas fa-redo mr-2"></i>
                            Resend Verification Email
                        </a>
                        <a href="<?= rtrim(str_replace('/public', '', BASE), '/') . '/public/index.php?p=login&tab=login' ?>" class="block w-full bg-gray-100 text-gray-700 font-semibold py-3 px-6 rounded-xl hover:bg-gray-200 transition-all dura
                            <i class="fas fa-sign-in-alt mr-2"></i>
                            Go to Login
                        </a>
                    </div>
