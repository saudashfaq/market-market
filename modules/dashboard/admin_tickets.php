    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md mb-6">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex-1">
                        <form method="GET" action="" class="flex gap-2">
                            ...
                            >
                            <button type="submit" class="brand-bg text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition">
                                <i class="fas fa-search mr-2"></i>Search
                            </button>
                            <?php if ($search): ?>
                                <a href="?p=dashboard&page=admin_tickets<?= $status ? '&status=' . $status : '' ?>" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
            ...
            <div class="flex border-t border-gray-200">
                <a href="?p=dashboard&page=admin_tickets<?= $search ? '&search=' . urlencode($search) : '' ?>" 
                ...
                <a href="?p=dashboard&page=admin_tickets&status=open<?= $search ? '&search=' . urlencode($search) : '' ?>" 
                ...
                <a href="?p=dashboard&page=admin_tickets&status=closed<?= $search ? '&search=' . urlencode($search) : '' ?>" 
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4">
                                        <div class="flex items-start gap-3">
                                            <div class="brand-bg text-white px-3 py-1 rounded-lg text-sm font-bold">
                                                #<?= $ticket['id'] ?>
                                            </div>
                                            <div>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="<?= url('index.php?p=dashboard&page=admin_ticket_view&id=' . $ticket['id']) ?>" 
                                           class="brand-bg text-white px-4 py-2 rounded-lg text-sm font-semibold hover:opacity-90 transition inline-flex items-center">
