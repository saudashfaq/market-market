...
<aside
  ...
  <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto sidebar-scroll">
    ...
    <hr class="my-4 border-gray-200">
      <a href="<?= url('logout') ?>" onclick="confirmLogout(event)" class="group flex items-center px-3 py-2.5 mx-1 rounded-lg text-red-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-red-100 transition" title="Logout">
