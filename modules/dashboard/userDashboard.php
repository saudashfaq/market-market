...
<div class="bg-gradient-to-br from-white via-blue-50 to-indigo-50/50 min-h-screen text-gray-800 font-[Inter]">
      ...
      <div class="min-h-[70vh] flex items-center justify-center">
        <div class="text-center max-w-2xl mx-auto p-8">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?= url('index.php?p=listing') ?>" class="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-semibold text-lg shadow-lg hover:shadow-xl">
              <i class="fas fa-store mr-3"></i>
              Browse Marketplace
            </a>
            <a href="<?= url('index.php?p=sellingOption') ?>" class="inline-flex items-center px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition font-semibold text-lg">
    ...
    <?php else: ?>
      ...
      <section class="mb-10">
        <div class="flex flex-col sm:flex-row justify-between sm:items-center mb-4 gap-2">
          ...
          <a href="<?= url('index.php?p=dashboard&page=offers') ?>" class="text-sm text-blue-600 hover:underline font-medium text-center sm:text-right">
            View All
          </a>
        </div>
        <?php if (empty($recentOffers)): ?>
          <div class="bg-white p-8 sm:p-12 rounded-xl border border-gray-100 shadow text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="<?= url('index.php?p=sellingOption') ?>" class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                <i class="fas fa-plus-circle mr-2"></i>
                Start Selling
              </a>
              <a href="<?= url('index.php?p=dashboard&page=offers') ?>" class="inline-flex items-center justify-center px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-all duration-200 font-semibold">
      ...
      <section>
        <div class="flex flex-col sm:flex-row justify-between sm:items-center mb-4 gap-2">
          ...
          <a href="<?= url('index.php?p=dashboard&page=my_order') ?>" class="text-sm text-blue-600 hover:underline font-medium text-center sm:text-right">
            View All
          </a>
        </div>
        <?php if (empty($recentOrders)): ?>
          <div class="bg-white p-8 sm:p-12 rounded-xl border border-gray-100 shadow text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="<?= url('index.php?p=listing') ?>" class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                <i class="fas fa-store mr-2"></i>
                Start Shopping
              </a>
              <a href="<?= url('index.php?p=dashboard&page=my_order') ?>" class="inline-flex items-center justify-center px-6 py-3 border-2 border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition-all duration-200 font-semibold">
                <i class="fas fa-history mr-2"></i>
                View Order History
              </a>
            </div>
