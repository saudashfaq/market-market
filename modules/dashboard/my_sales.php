        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 text-center">
                ...
                <div class="flex items-center justify-center gap-4">
                    ...
                    echo getExportButton('credentials'); ?>
                </div>
                ...
                <?php else: ?>
                    <div class="grid gap-6 max-w-4xl mx-auto">
                        <?php foreach ($sentCredentials as $item): ?>
                            ...
                            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 transition-all duration-200 hover:shadow-md <?= $needsAction ? 'border-l-4 border-l-orange-500' : '' ?>" data-transaction-id="<?= $item['id'] ?>">
                ...
                <?php else: ?>
                    <div class="grid gap-6 max-w-4xl mx-auto">
                        <?php foreach ($receivedCredentials as $item): ?>
                            ...
                            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 transition-all duration-200 hover:shadow-md" data-transaction-id="<?= $item['id'] ?>">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3 mb-3">
                                            <h3 class="text-lg font-semibold text-gray-900"><?= htmlspecialchars($item['listing_name']) ?></h3>
