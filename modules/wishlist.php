                    ...
                    <div class="group relative rounded-2xl border border-gray-200 shadow-md hover:shadow-lg transition-all duration-500 overflow-hidden hover:-translate-y-2 bg-white">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button onclick="showMakeOfferPopup(<?= $listing['id'] ?>, '<?= htmlspecialchars($listing['name']) ?>', '<?= htmlspecialchars($listing['asking_price']) ?>')" class="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white text-sm font-semibold py-3 rounded-md hover:opacity-90 transition-opacity">
